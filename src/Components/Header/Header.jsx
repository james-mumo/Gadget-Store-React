      ...
      <header className="top-header">
        ...
        <div className="header-icons col-md-3 clearfix d-flex  justify-content-center">
          <div className="flex position-relative">
            <span
              className="icon position-relative z-1"
          ...
          <div className="d-block position-relative">
            <div className="d-flex gap-1 avatar__container">
              <img
                src={current ? current.photoURL : "../photos/avatar1.png"}
                alt="avatar"
              />
              <span
          ...
          <div className={menu ? "menu active" : "menu"}>
            <div className="d-lg-none">
              <ul>
                ...
                <li>
                  <a href="#today" onClick={handleClick}>
                    Today's Deal
                  </a>
                </li>
                <li>
                ...
                <li>
                  <a href="#trending" onClick={handleClick}>
                    Trending
                  </a>
                </li>
                <li>
